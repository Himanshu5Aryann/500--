...
export default function Hero() {
  return (
    <section className="relative h-[100svh] min-h-[560px] w-full overflow-hidden bg-forest-deep">
      ...
      <a
        href="tel:07009248451"
        aria-label="Call The Interior & Exterior Solution"
        className="fixed right-[18px] top-[58%] z-20 flex h-14 w-14 items-center justify-center rounded-full border border-gold/60 bg-forest/75 text-gold-light backdrop-blur-sm shadow-[0_10px_24px_rgba(9,18,17,0.28)] transition-all duration-300 hover:scale-105 active:scale-95 lg:hidden"
      >
        <svg
          viewBox="0 0 24 24"
          fill="none"
          ...
          aria-hidden="true"
        >
          <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07A19.5 19.5 0 0 1 3.07 9.81 19.86 19.86 0 0 1 0 1.18 2 2 0 0 1 2 0h3a2 2 0 0 1 2 1.72c.12.86.33 1.71.62 2.52a2 2 0 0 1-.45 2.11L6 7.91a16 16 0 0 0 9.09 9.09l1.56-1.19a2 2 0 0 1 2.11-.45c.81.29 1.66.5 2.52.62A2 2 0 0 1 22 16.92Z" />
        </svg>
      </a>
    </section>
  );
